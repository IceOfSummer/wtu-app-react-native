...
export function encodeOnlineChatMessage(message: OnlineChatMessage): Uint8Array {
  ...
  _encodeOnlineChatMessage(message, bb);
  return toUint8Array(bb);
}

function _encodeOnlineChatMessage(message: OnlineChatMessage, bb: ByteBuffer): void {
  // optional int32 to = 2;
  let $to = message.to;
  if ($to !== undefined) {
    writeVarint32(bb, 16);
...
export function decodeOnlineChatMessage(binary: Uint8Array): OnlineChatMessage {
  return _decodeOnlineChatMessage(wrapByteBuffer(binary));
}

function _decodeOnlineChatMessage(bb: ByteBuffer): OnlineChatMessage {
  let message: OnlineChatMessage = {} as any;
